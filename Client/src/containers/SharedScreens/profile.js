...
const Portfolio = () => {
  ...
  const fetchUserProfileDetails = () => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/profile/${_id}`)
      ...
      <div className="container">
        <div className="user_profile">
          <div className="user_img">
            {loading ? (
              <img
                src={require(`../../../src/uploads/${
                  userDetails.avatarFileName || "card_img.jpg"
                }`)}
                alt="profile"
                height={"100%"}
                width={"100%"}
          ...
          <div className="uploader">
            <input
              onChange={(e) => avatarupload(e.target.files[0])}
              type="file"
              id="upload"
              hidden
            />
          ...
          <div className="user_detail">
            ...
            <p>
              {userDetails.permanentAddress}, {userDetails.country}
            </p>
          </div>
        </div>
      </div>
