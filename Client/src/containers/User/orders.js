              ...
              <Form onSubmit={handleSubmit}>
                ...
                >
                  <option
                    ...
                    label="Product Type"
                  ></option>
                  <option value="documents" label="Documents">
                    Documents
                  </option>
                  <option value="clothing" label="Clothing">
                    Clothing
                  </option>
                  <option value="jewelleries" label="Jewelleries">
                    Jewelleries
                  </option>
                ...
                <Field
                  name="maxSize"
                  placeholder="Max Size (in meters)"
                  value={values.maxSize}
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
                {errors.maxSize && touched.maxSize ? (
                  <div className="error">{errors.maxSize}</div>
                ) : null}
                ...
                <Field
                  ...
                  value={values.receipentLocation}
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
