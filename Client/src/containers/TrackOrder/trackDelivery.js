...
const TrackDelivery = () => {
  ...
  const searchDelivery = async (values, resetForm) => {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_BASE_URL}/searchdelivery`,
      requestOptions
    );
              ...
              {({
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  {errors.trackID && touched.trackID ? (
                    <div className="error">{errors.trackID}</div>
                  ) : null}
            ...
            items={[
              {
                ...
                description:
                  deliveryStatus == "pending"
                    ? "Your order is not yet approved"
              ...
              },
              {
                ...
                description:
                  deliveryStatus == "productDispatched"
                    ? "Order has been dispatched to deliver"
                    : "",
              ...
              },
              {
                ...
                description:
                  deliveryStatus == "productDelivered" ? "Order Delivered" : "",
